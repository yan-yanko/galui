...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'White-label badge ✓', ok: true },
...
const COMPARISON = [
  { feature: 'Sites', free: '3', starter: '1', pro: '10', agency: '∞' },
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 18, color: 'var(--muted)', maxWidth: 520, margin: '0 auto 32px' }}>
            Scanning is always free. The JS snippet — which activates AI visibility, analytics, and auto-updates — requires a paid plan.
          </p>
